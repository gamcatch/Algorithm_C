/**
Deque 는 Queue의 일반화된 버전으로 Queue의 양 끝에서 데이터의 삽입 / 삭제가 가능하게 끔 만든 자료 구조이다. 

크기가 N인 Queue에서 주어진 M개의 Command를 수행하는 프그램을 작성하라 
...
int main(void) {
    ...
    freopen("./data_structure/deque_input.txt", "r", stdin);
